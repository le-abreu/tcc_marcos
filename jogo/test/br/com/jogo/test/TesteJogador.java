...
public class TesteJogador {
	...
	public void testarContadores() {
		...
		assertEquals("Arma favorita nao confere", M16,
				jogador.getNomeArmaFavorita());
